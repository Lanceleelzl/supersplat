...
const zhCN = {
    translation: {
        ...
        'panel.view-options.high-precision': '高精度渲染',
        ...
        'popup.shortcuts.hide-selected-splats': '隐藏选择的 Splat',
        'popup.shortcuts.unhide-all-splats': '显示全部 Splat',
        ...
        'popup.export.compress-ply': '压缩PLY',
        'popup.export.splats-select': 'Splat',
        'popup.export.splats-select.all': '所有Splat',
        ...
        'tooltip.right-toolbar.splat-mode': 'Splat 模式 ( M )',
        'tooltip.right-toolbar.show-hide': '显示/隐藏 Splats ( Space )',
        'tooltip.right-toolbar.frame-selection': '框选 ( F )',
        'tooltip.right-toolbar.reset-camera': '重置相机',
        'tooltip.right-toolbar.colors': '颜色',
        'tooltip.right-toolbar.view-options': '视图选项',
        'tooltip.bottom-toolbar.undo': '撤销 ( Ctrl + Z )',
        'tooltip.bottom-toolbar.redo': '重做 ( Ctrl + Shift + Z )',
        'tooltip.bottom-toolbar.rect': '矩形选择 ( R )',
        'tooltip.bottom-toolbar.lasso': '套索选择 ( L )',
        'tooltip.bottom-toolbar.polygon': '多边形选择 ( P )',
        'tooltip.bottom-toolbar.brush': '画笔 ( B )',
        'tooltip.bottom-toolbar.flood': '填充选择 ( O )',
        'tooltip.bottom-toolbar.eyedropper': '吸管选择 ( E )',
        'tooltip.bottom-toolbar.sphere': '球选择',
        'tooltip.bottom-toolbar.box': '盒选择',
        'tooltip.bottom-toolbar.translate': '移动 ( 1 )',
        ...
        'tooltip.timeline.next-key': '下一个关键帧',
